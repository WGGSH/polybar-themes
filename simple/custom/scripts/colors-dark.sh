...
RESOURCE_FILE="$HOME/.Xresources-look"
...
i3-wm.client.focused.color.border: ${AC}40
i3-wm.client.focused.color.background: ${AC}40
i3-wm.client.unfocused.color.border: #141C2140
i3-wm.client.unfocused.color.background: #141C2140
	EOF
